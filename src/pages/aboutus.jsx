    ...
    <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto bg-white p-6 md:p-8 rounded-lg shadow-lg">
          ...
          >
            <img
              ...
              alt="About Us"
              className="rounded-lg shadow-md w-full max-w-[300px] sm:max-w-[400px] lg:max-w-[390px] object-cover hover-zoom mt-2 sm:mt-2 md:mt-10 lg:mt-20"
            />
      ...
      <div className="min-h-screen bg-gray-100 py-12 px-4 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto bg-white p-6 md:p-8 rounded-lg shadow-lg">
          ...
          <div
            ref={rightRef2}
            className={`flex justify-center items-center ${rightInView2 ? 'animate-slide-in-right' : ''}`}
          >
            <img
              ...
              alt="About Us"
              className="rounded-lg shadow-md w-full  max-w-[300px] md:max-w-[400px] lg:max-w-[400px] object-cover hover-zoom"
            />
          </div>
        </div>
      </div>
